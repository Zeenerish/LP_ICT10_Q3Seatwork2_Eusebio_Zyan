...
def strange(event):
    ...
    if answer1 and answer3:
        ...
        if registration_choice == "yes" and clearance_choice == "yes1":
            ...
            images_data = {
                "bluebird.jpg": "Congratulations! You are part of Blue Bears!",
                "dogsred.jpg": "Congratulations! You are part of Red Buldogs!",
                "freakytigers.jpg": "Congratulations! You are part of Yellow Tigers!",
                "charlottehornets.jpg": "Congratulations! You are part of Green Hornets!"
            }
